...
Scenario: 
	usernameProperty & passwordProperty & settingsKey but no corresponding settings 
...
Scenario: 
	usernameProperty & passwordProperty & settingsKey with corresponding settings 
...
Scenario: 
	settingsKey only with corresponding settings and using System properties 
...
Scenario: 
	usernameProperty & passwordProperty & settingsKey with corresponding settings AND previously existing properties, the existing properties should win 
